...
import iread from "../../../assets/iread/iread_22_9.jpg";
      ...
      <Grid container margin={{ xs: "8% 0%", sm: "2% 0%" }}>
        <Grid xs={12} sm={6} paddingRight={"3%"}>
          ...
          <Typography
            ...
            lineHeight={1.5}
          >
            The Literacy Awards 1.0 was held on March 12, 2022 at the the
            Liberty Event Centre, Ogbomoso. The theme for this event was
            "Enhancing Literacy Through Civic Education". This event which was a
            quiz competition was in two parts. In the first part of the event,
            22 students from 11 schools participated out of which one 10
          ...
          >
            ...
            School of Science, and <strong> Ashafat Faridat </strong> from
            Relics College.
          </Typography>
          <Typography
            variant={"body1"}
