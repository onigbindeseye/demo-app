...
import media2 from "../assets/media/media_2.png";

const media = [
  {
    year: "2017",
    icon: <HandymanIcon sx={{ width: 30, height: 30, color: "#fff" }} />,
    title: "The Ikoyi-Ile Road Project",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Tellus orci ac auctor augue mauris augue neque gravida in. Tristique senectus et netus et malesuada fames ac turpis. Nunc non blandit massa enim nec. Venenatis urna cursus eget nunc scelerisque viverra mauris. Etiam erat velit scelerisque in dictum non.",
    images: media1,
  },
  {
    year: "2017",
